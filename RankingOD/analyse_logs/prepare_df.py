...
def results_dataframe_counts(odarray,filename):
    ...
    group_df['Date'] = filename  # add date column, date is just the filename
...
def all_results_with_count(origin_df,filename):
    ...
    count_df = results_dataframe_counts(origin_df)
    ...
    result['Date'] = filename  # add date column, date is just the filename
